    ...
    <>
      <Flex direction="column" ml="9" maxWidth="1000px" gap="4" justify="center">
        <Text mb="6" size="5" weight="medium">
          <Strong>Scenario: </Strong> This dataset shows height and weight measurements for six individuals, ranging from 165 cm and 65 kg to 180 cm and 87 kg. It illustrates a clear relationship: as height increases, weight also tends to increase. The shortest person in the group (165 cm) weighs 65 kg, while the tallest (178 cm) weighs 87 kg.
