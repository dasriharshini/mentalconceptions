  ...
  const handleNextButtonClick = async (e: { preventDefault: () => void }) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        router.push("https://neu.co1.qualtrics.com/jfe/form/SV_cUV9fSjnq4BQ114");
      } else {
    ...
    <>
      <Flex direction="column" ml="9" maxWidth="1000px" gap="4" justify="center">
        <Text mb="6" size="5" weight="medium">
          <Strong>Scenario: </Strong> This dataset shows oil prices from January to April 2020. Over these four months, prices dropped sharply. The price was $58 in January, then fell to $51 in February, $29 in March, and finally $17 in April. Overall, this represents a major decline in oil prices during a short period.
      ...
      <Flex direction="column" ml="9" maxWidth="1000px" gap="4" justify="center">
        <Text mb="6" size="5" weight="medium">
          <Strong>Scenario: </Strong> This dataset shows room service prices for three items—sandwich, bottled water, and peanuts—in Helsinki, Seoul, and Copenhagen. Helsinki is the most expensive, with prices of $39, $14, and $6. Seoul is next at $28, $13, and $7. Copenhagen is the cheapest, with prices of $26, $11, and $4. This data set shows apparent cost differences between the cities.
      ...
      <Flex align="center" justify="center" mt="6">
        <Link href="https://neu.co1.qualtrics.com/jfe/form/SV_cUV9fSjnq4BQ114">
